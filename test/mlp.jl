...
## @time g, W, E, stab = DeepMP.solve(K=[301,5,1] ,layers=[:bpreal,:bpex]
...
# @time g, W, E, stab = DeepMP.solve(α=0.25, K=[301,21,11,3,1]
...
# @time g, W, E, stab = DeepMP.solve(α=0.2, K=[301,21,11,3,1]
...
# @time g, W, E, stab = DeepMP.solve(α=0.15, K=[301,21,11,3,1]
#                    , layers=[:tap,:tap,:tapex,:bpex]
